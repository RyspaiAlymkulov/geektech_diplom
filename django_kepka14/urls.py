...
urlpatterns = [
    ...
    path(r'api/v1/', include(router.urls)),
    path('api/v1/caps/<int:id>/', views.CapsUpdateDeleteAPIView.as_view()),
    path('api/v1/api/v1/maimmenu/', views.MainMenuListAPIView.as_view()),
    path('api/v1/categories/', views.CategoryListCreateAPIView.as_view()),
    path('api/v1/brands/<int:id>/', views.BrandUpdateDeleteAPIView.as_view()),
    path('api/v1/categories/<int:id>/', views.CategoryUpdateDeleteAPIView.as_view()),
